...
Returns (xmin,ymin,xmax,ymax) boundary of image. Will be in projected coordinates if a L<Geo::Proj4> projection object isn't passed.
...
Convenience entry method to get_iterator_* methods.
